...
func TestGame(t *testing.T) {
	...
	teamHome := Team{
		Name: "Home",
		Squad: Squad{
			Seeker:  Player{FirstName: "home-seeker", Power: 10, Stamina: 100},
			Chaser1: Player{FirstName: "home-chaser-1", Power: 10, Stamina: 100},
			Chaser2: Player{FirstName: "home-chaser-2", Power: 10, Stamina: 100},
			Chaser3: Player{FirstName: "home-chaser-3", Power: 10, Stamina: 100},
			Beater1: Player{FirstName: "home-beater-1", Power: 10, Stamina: 100},
			Beater2: Player{FirstName: "home-beater-2", Power: 10, Stamina: 100},
			Keeper:  Player{FirstName: "home-keeper", Power: 10, Stamina: 100},
		},
	}
